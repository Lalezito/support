#!/bin/bash
# ============================================================================
# AGENT 5: EXTRACTOR_DE - Extractor de Alemán
# ============================================================================
# Rol: Extraer keys de Cosmic Coach del archivo app_de.arb
...
echo "🟠 AGENT 5: EXTRACTOR_DE - Iniciando extracción..."
echo ""
...
cat > "$OUTPUT_DIR/agent5_extractor_${LANG}_report.txt" << EOF
=============================================================================
AGENT 5: EXTRACTOR_DE - Reporte de Extracción
=============================================================================
Fecha: $(date)
...
cat "$OUTPUT_DIR/agent5_extractor_${LANG}_report.txt"

echo ""
echo "✅ AGENT 5: EXTRACTOR_DE - Completado exitosamente"
echo ""
echo "📊 Resumen:"
