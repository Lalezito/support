#!/bin/bash
# ============================================================================
# AGENT 6: EXTRACTOR_FR - Extractor de Francés
# ============================================================================
# Rol: Extraer keys de Cosmic Coach del archivo app_fr.arb
...
echo "🔴 AGENT 6: EXTRACTOR_FR - Iniciando extracción..."
echo ""
...
cat > "$OUTPUT_DIR/agent6_extractor_${LANG}_report.txt" << EOF
=============================================================================
AGENT 6: EXTRACTOR_FR - Reporte de Extracción
=============================================================================
Fecha: $(date)
...
cat "$OUTPUT_DIR/agent6_extractor_${LANG}_report.txt"

echo ""
echo "✅ AGENT 6: EXTRACTOR_FR - Completado exitosamente"
echo ""
echo "📊 Resumen:"
